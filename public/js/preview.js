window.onload = function () {
    ...
    function handleResize() {
        const isMobileNow = ucyCore.isMobile();
    ...
    function initScrollTrigger() {
        ...
        const galleryElement = document.querySelector(".preview-body .gallery");
        ...
        // 使用 Swiper 容器高度除以 slidesPerView
        ...
        const scrollPerSlide = slideHeight / 2;
